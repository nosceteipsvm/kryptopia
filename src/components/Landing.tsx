		...
		<>
			<div className="pt-24">
				...
				<div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center text-white">
					...
					<div className="flex flex-col w-full pl-8 md:w-2/5 justify-center items-start text-center md:text-left">
						<p className="uppercase tracking-loose w-full">Occupy knausgaard twee try-hard?</p>
						<h1 className="my-4 text-5xl font-bold leading-tight">keffiyeh kitsch post-ironic waistcoat!</h1>
						...
						<button className="mx-auto lg:mx-0 hover:underline gradient-b text-white font-semibold rounded-full my-4 py-4 px-8 shadow-lg outline-none focus:outline-none">Read More</button>
						
					</div>
					
					<div className="w-full md:w-3/5 py-6 text-center">
						<img className="w-full z-50" src="../public/blockchain.png"/>
					</div>
			...
			<section className=" bg-black py-8">
				<div className="container max-w-5xl mx-auto m-8">
					<h1 className="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-400">PBR&B</h1>
					...
					<div className="flex flex-wrap">
						<div className="w-5/6 sm:w-1/2 p-6">
							<h3 className="text-3xl text-gray-500 font-bold leading-none mb-3">Flexitarian cold-pressed +1</h3>
						...
						<div className="w-full sm:w-1/2 p-6 mt-6">
							<div className="align-middle">
								<h3 className="text-3xl text-gray-500 font-bold leading-none mb-3">Mlkshk</h3>
								<p className="text-gray-400 mb-8">
			...
			<section className="gradient py-8">
				
				<div className="container mx-auto flex flex-wrap pt-4 pb-12">
				
					<h1 className="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-400">Ennui</h1>
					...
					<div className="w-full md:w-1/3 p-6 flex flex-col">
						<div className=" bg-black rounded-t rounded-b-none overflow-hidden shadow p-4">
							<a href="#" className="flex flex-wrap no-underline hover:no-underline">
								...
								<div className="w-full text-center pt-4 font-bold text-xl text-gray-500 px-6">Schlitz Organic</div>
								<p className="text-gray-400 text-base pt-6 px-6 mb-5">
					...
					<div className="w-full md:w-1/3 p-6 flex flex-col">
						<div className="bg-black rounded-t rounded-b-none overflow-hidden shadow p-4">
							<a href="#" className="flex flex-wrap no-underline hover:no-underline">
								...
								<div className="w-full text-center pt-4 font-bold text-xl text-gray-500 px-6">Wayfarers</div>
								<p className="text-gray-400 text-base pt-6 px-6 mb-5">
					...
					<div className="w-full md:w-1/3 p-6 flex flex-col">
						<div className=" bg-black rounded-t rounded-b-none overflow-hidden shadow p-4">
							<a href="#" className="flex flex-wrap no-underline hover:no-underline">
								...
								<div className="w-full text-center pt-4 font-bold text-xl text-gray-500 px-6">Brooklyn 8-Bit</div>
								<p className="text-gray-400 text-base pt-6 px-6 mb-5">
			...
			<section className="bg-black">
				...
				<div className="container mx-auto px-2 pt-4 pb-12 text-gray-600">

					<h1 className="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-400">Pricing</h1>
					<div className="w-full mb-4">	
						<div className="h-1 mx-auto bg-gray-700 w-64 opacity-25 my-0 py-0 rounded-t"></div>
					</div>
						...
						<div className="flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-white mt-4">
							<div className="flex-1 bg-black border border-gray-800 text-gray-600 rounded-t rounded-b-none overflow-hidden shadow">
								...
								<ul className="w-full text-center text-sm">
									...
									<li className="border-b py-4 text-gray-400 border-gray-800">Ethical gochujang asymmetrical hexagon</li>
								</ul>
							</div>
						...
						<div className="flex flex-col w-5/6 lg:w-1/3 mx-auto lg:mx-0 rounded-lg bg-white mt-4 sm:-mt-6 shadow-lg z-10">
							<div className="flex-1 bg-black border border-gray-800 rounded-t rounded-b-none overflow-hidden shadow">
								...
								<ul className="w-full text-center text-base">
									<li className="border-b py-4 text-gray-400 border-gray-800">Vegan food truck mumblecore</li>
									<li className="border-b py-4 text-gray-400 border-gray-800">Hexagon</li>
									<li className="border-b py-4 text-gray-400 border-gray-800">Echo party chicken</li>
									<li className="pt-6 text-gray-400">PBR&B</li>
								</ul>					
							</div>
							<div className="flex-none mt-auto bg-black border border-gray-800 rounded-b rounded-t-none overflow-hidden shadow p-6">
			...
			<section className="container gradient-c h-full mx-auto text-center py-6">

				<h1 className="w-full my-2 text-5xl font-bold leading-tight text-center text-white">Typewriter af marfa</h1>
				<div className="w-full mb-4">	
					<div className="h-1 mx-auto bg-black w-1/6 opacity-25 my-0 py-0 rounded-t"></div>
				</div>

				<h3 className="my-4 text-3xl text-white leading-tight">Vape +1 man braid la croix!</h3>
